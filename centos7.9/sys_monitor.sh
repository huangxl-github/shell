...
function script::history_monitor() {
	cat << EOF > /etc/profile.d/history_monitor.sh
	export PS1='[\u@\h \w]# '  
	history  
	...
	export HISTFILE="/opt/history/\${LOGNAME}/\${USER_IP}_history_\$DT"  
...
echo -e "\033[0;32m
系统运维脚本 by huangxiaolong\033[0m"
